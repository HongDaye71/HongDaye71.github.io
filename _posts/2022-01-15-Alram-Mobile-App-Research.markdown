...
|어플|잠 깨우기 기능|부차기능|리뷰개수|키워드 빈도수|
|------|---|---|---|---|
|초강력 알람|핸드폰 흔들기|-|108개|- 좋아요(30.6%)<br/>- 흔들기(13.9%)<br/> - 소리(15.7%)|
|알라미|사진찍기·수학문제·스쿼트·텍스트따라쓰기 미션|날씨·운세·뉴스|280개|- 좋아요(32.9%)<br/>- 안울려요(17.6%)|
|말하는 알람|음성메시지 재생 및 수학문제·핸드폰 흔들기 미션|-|425개|- 좋아요(48.2%)<br/>- 단순,깔끔,크고(5.6%)|
|내 시계|기본 사운드기능 및 깜박이는 불빛|타이머·스톱워치·세계시계|235개|- 좋아요(38.3%)<br/>- 단순,깔끔,크고(8.5%)|
|간단한 알람|사용자 지정 알람음(노래)설정|-|64개|- 좋아요(56.3%)<br/>- 단순,깔끔,크고(17.2%)<br/>- 소리(6.3%)|
